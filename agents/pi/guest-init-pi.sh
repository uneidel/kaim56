...
echo "[init] pi-agent transport=${TRANSPORT:-signal} model=${PI_MODEL:-default} provider=${PI_PROVIDER:-auto} workdir=$WORKDIR"
cd "$WORKDIR"
...
setpriv --reuid=1000 --regid=1000 --init-groups python3 -u /app/pi_bridge.py
